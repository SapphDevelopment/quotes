...
const quote: Quote[] = [
   ...
   */
  {
    ...
    category: categories.motivation && categories.inspiration,
    tags: ["motivation", "motivate"],
  },
  {
  ...
  // 40 Motiviation Quotes - https://parade.com/973277/jessicasager/inspirational-quotes/
  /**
   * Happy Quotes
   */
  {
